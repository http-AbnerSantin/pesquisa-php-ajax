...
$query = "
    SELECT codigo_barras, codigo_fornecedor, descricao, marca_id, e1, unidade_id, custo_venda, (custo_venda * e1) as total, codigo_fabricante
    FROM 
        itens
    WHERE e1 > 0";
...
while ($row = $sql->fetch(PDO::FETCH_ASSOC)) {
    ...
    $linha = 
        ...
        " " .
        str_pad($row['e1'], 7, " ", STR_PAD_RIGHT) . // Quantidade
        " " .
