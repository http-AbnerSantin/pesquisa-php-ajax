...
$query = "
    SELECT codigo_barras, codigo_fornecedor, descricao, marca_id, e2, unidade_id, custo_venda, (custo_venda * e1) as total, codigo_fabricante
    FROM 
        itens
    WHERE e2 > 0";
...
while ($row = $sql->fetch(PDO::FETCH_ASSOC)) {
    ...
    $linha = 
        ...
        " " .
        str_pad($row['e2'], 7, " ", STR_PAD_RIGHT) . // Quantidade
        " " .
